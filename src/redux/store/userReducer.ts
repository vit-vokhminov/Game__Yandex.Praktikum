...
export const GAME_RUNNER = 'GAME_RUNNER';
...
export default function userReducer(
    ...
    switch (action.type) {
        ...
        case SERVER_MESSAGE:
            return { ...state, serverMessage: (action as ActionType<string>).payload };
        case GAME_RUNNER:
            return { ...state, gameRunner: (action as ActionType<boolean>).payload };
        default:
            break;
    }
    return state;
...
export const setGameStart = (payload: boolean) => ({ type: GAME_RUNNER, payload });

export const sagaFetchLogin = (payload: any) => ({ type: LOGIN, payload });
export const sagaFetchRegistration = (payload: any) => ({ type: REGISTRATION, payload });
export const sagaFetchLogout = (payload: void) => ({ type: LOGOUT, payload });
export const sagaFetchCheckAuth = (payload: void) => ({ type: CHECK_AUTH, payload });
